...
These challenges demonstrate that **although there are conventional methods** established for neuron activation and gradient stepping, **the details behind these conventions** are **subject to change** depending on the **context** of the dataset and application.
